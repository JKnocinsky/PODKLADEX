...
('Szczepan', 'Witosławski', '123456789', 'szczepan.witoslawski@email.com', 'Warszawa', '00-021', 'Kocjana', '34', '39123848473'),
('Jakub', 'Knociński', '111222333', 'jakub.knocinski@email.com', 'Warszawa', '00-001', 'Marszałkowska', '10', '39123804281'),
('Filip', 'Przybylski', '222333444', 'filip.przybylski@email.com', 'Kraków', '30-001', 'Floriańska', '15', '39105725472'),
('Mateusz', 'Miazga', '333444555', 'mateusz.miazga@email.com', 'Poznań', '60-001', 'Polwiejska', '20', '02848718374'),
('Maciej', 'Wolski', '444555666', 'maciej.wolski@email.com', 'Wrocław', '50-001', 'Świdnicka', '5', '02384620411'),
('Anna', 'Nowak', '555666777', 'anna.nowak@email.com', 'Lodz', '90-001', 'Piotrkowska', '101', '91020345678'),
('Piotr', 'Kowalski', '666777888', 'piotr.kowalski@email.com', 'Gdańsk', '80-001', 'Dluga', '7', '88071534567'),
('Karolina', 'Zielińska', '777888999', 'karolina.zielinska@email.com', 'Lublin', '20-001', 'Narutowicza', '18', '95042156789'),
('Paweł', 'Mazur', '888999000', 'pawel.mazur@email.com', 'Białystok', '15-001', 'Sienkiewicza', '22', '92091867891');
GO
...
('Metal-Szpula s.c.', 'Dąbrowa Górnicza', '41-300', 'Przemysłowa', '112', '6291112233'),
...
(1, 1, '2024-03-14', '2026-04-05'),
(2, 2, '2024-03-23', NULL),
(3, 3, '2024-03-01', '2024-04-06'),
(4, 4, '2024-03-09', '2026-04-07'),
(5, 5, '2024-03-28', NULL);
GO
...
('Rehabilitacyjne', 'Świadczenie rehabilitacyjne');
GO

INSERT INTO Typ_badania_med (Nazwa, Opis) VALUES
('Wstępne', 'Badanie przed rozpoczęciem pracy'),
('Okresowe', 'Badanie okresowe pracownika'),
('Kontrolne', 'Badanie po dłuzszej nieobecności');
GO
...
(2, '2026-01-01', '2026-12-31', 1),
(3, '2026-01-01', '2026-12-31', 1);
GO
...
(1, 1, '2026-01-10', '2027-01-10', 150.00, 'Okresowe - produkcja'),
(2, 1, '2026-01-10', '2027-01-10', 150.00, 'Okresowe - produkcja'),
(3, 1, '2026-01-10', '2027-01-10', 150.00, 'Okresowe - produkcja');
GO
...
-- Pracownik 1
(1, 1, '2026-01-15', '2027-01-15', 200.00), -- Grupa 1 (1 lub 2)
(1, 6, '2026-01-15', '2027-01-15', 300.00), -- Grupa 2 (6 lub 7)
-- Pracownik 2
(2, 1, '2026-01-15', '2027-01-15', 200.00), 
(2, 6, '2026-01-15', '2027-01-15', 300.00),
-- Pracownik 3
(3, 1, '2026-01-15', '2027-01-15', 200.00),
(3, 6, '2026-01-15', '2027-01-15', 300.00);
GO
...
('Wykrojnik_fi8',NULL),
('Wykrojnik_fi10',NULL),
('Wymienne_ostrze_1','Wymienne ostrze do nożyc gilotynowych'),
('Wykrojnik_fi12',NULL),
('Wykrojnik_fi6',NULL),
('Ostrze_2',NULL),
('Ostrze_3',NULL),
...
-- Maszyna 1
(1,'2026-03-02',1,'Uszkodzenie','2026-03-03'),
(1,'2026-03-05',2,'Przegrzanie','2026-03-06'),

-- Maszyna 2
(2,'2026-03-03',2,'Zniszczenie','2026-03-04'),
(2,'2026-03-07',3,'Awaria silnika','2026-03-08'),

-- Maszyna 3
(3,'2026-03-06',3,'Wypadek','2026-03-07'),
(3,'2026-03-09',4,'Uszkodzenie osi','2026-03-10'),

-- Maszyna 4
(4,'2026-03-11',4,'Hałas','2026-03-12'),
(4,'2026-03-14',5,'Luzy mechaniczne','2026-03-15'),

-- Maszyna 5
(5,'2026-03-13',5,'Przegrzewanie','2026-03-14'),
(5,'2026-03-17',6,'Wycieki','2026-03-18'),

-- Maszyna 6
(6,'2026-03-16',6,'Drgania','2026-03-17'),
(6,'2026-03-20',7,'Uszkodzenie łożyska','2026-03-21'),

-- Maszyna 7
(7,'2026-03-21',7,'Awaria całkowita','2026-03-22'),
(7,'2026-03-24',8,'Problem elektryczny','2026-03-25'),

-- Maszyna 8
(8,'2026-03-26',8,'Zużycie części','2026-03-27'),
(8,'2026-03-29',9,'Uszkodzenie napędu','2026-03-30'),

-- Maszyna 9
(9,'2026-04-02',9,'Uszkodzenie filtra','2026-04-03'),
(9,'2026-04-05',1,'Spadek wydajności','2026-04-06');
GO
...
(1,'2026-03-10',1,1,'OK','2026-03-10',5.00),
(1,'2026-03-14',2,2,'Kontrola','2026-03-14',3.50),
(2,'2026-03-11',2,2,'Brak','2026-03-11',6.00),
(2,'2026-03-15',3,1,'Przegląd','2026-03-15',2.50),
(3,'2026-03-12',3,3,'Konserwacja','2026-03-12',4.00),
(3,'2026-03-16',4,2,'Wymiana części','2026-03-16',3.00),
(4,'2026-03-13',4,1,'OK','2026-03-13',5.00),
(4,'2026-03-18',5,3,'Czyszczenie','2026-03-18',2.00),
(5,'2026-03-14',5,2,'Naprawa','2026-03-14',7.00),
(5,'2026-03-19',6,1,'Kontrola','2026-03-19',3.50),
(6,'2026-03-15',6,3,'Diagnostyka','2026-03-15',2.50),
(6,'2026-03-20',7,2,'Regulacja','2026-03-20',3.00),
(7,'2026-03-16',7,1,'OK','2026-03-16',2.00),
(7,'2026-03-21',8,3,'Konserwacja','2026-03-21',1.50),
(8,'2026-03-17',8,2,'Brak','2026-03-17',3.00),
(8,'2026-03-22',9,1,'Przegląd','2026-03-22',2.50),
(9,'2026-03-18',9,3,'Konserwacja','2026-03-18',1.50),
(9,'2026-03-23',1,2,'Wymiana części','2026-03-23',3.00);
GO
...
(1, '2026-03-01', '2026-03-05'),
(2, '2026-03-02', '2026-03-06'),
(3, '2026-03-05', '2026-03-10'),
(4, '2026-03-10', '2026-03-15'),
(5, '2026-03-12', '2026-03-18'),
(2, '2026-03-15', '2026-03-20'),
(3, '2026-03-20', '2026-03-25'),
(4, '2026-03-25', '2026-03-30'),
(5, '2026-04-01', '2026-04-11'),
(5, '2026-05-02', NULL);
GO
...
(1, 2.18, 50.00, 60.00, 1, 10), 
(2, 0.37, 10.00, 12.00, 2, 11), 
(1, 1.44, 40.00, 42.00, 3, 9), 
(3, 0.95, 20.00, 20.00, 4, 7),
(1, 1.49, 30.00, 30.00, 5, 3),
(2, 0.65, 15.00, 19.00, 6, 10), 
(3, 0.81, 30.00, 28.00, 7, 12), 
(1, 0.36, 10.00, 10.00, 8, 9), 
(2, 0.56, 15.00, 15.00, 9, 4), 
(3, 1.26, 30.00, 36.00, 10, 6);
GO
