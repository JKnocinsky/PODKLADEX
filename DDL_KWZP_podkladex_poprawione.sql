...
CREATE TABLE Osoba (
    ...
    Nr_telefonu NVARCHAR(12) NOT NULL,
...
CREATE TABLE Pracownik (
    ...
    ID_osoba INT REFERENCES Osoba(ID_osoba)
);
GO
...
CREATE TABLE Badanie_medyczne (
    ...
    ID_pracownik INT NOT NULL,
    ID_typ_badania_med INT NOT NULL,
    Data_badania DATE NOT NULL,
    Data_waznosci DATE NULL,
    Koszt DECIMAL(10,2) NOT NULL,
    Uwagi NVARCHAR(255) NULL,
    FOREIGN KEY (ID_pracownik) REFERENCES Pracownik(ID_pracownik),
    FOREIGN KEY (ID_typ_badania_med) REFERENCES Typ_badania_med(ID_typ_badania_med)
);
GO
...
CREATE TABLE Wniosek_urlopowy (
	...
	ID_urlopu INT NOT NULL,
    Status_wniosku BIT NOT NULL,
    FOREIGN KEY (ID_pracownik) REFERENCES Pracownik(ID_pracownik),
    FOREIGN KEY (ID_urlopu) REFERENCES Urlop(ID_urlopu)
);
GO
...
CREATE TABLE Zamowienie (
	...
	Data_zrealizowania_z DATE NOT NULL
);
GO

CREATE TABLE Wysylka_zamowienie (
	Wysylka_zamowienie INT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE Kontrola_mat (
    ...
    ID_zadanieP INT NOT NULL,
    ID_material INT NOT NULL,
	FOREIGN KEY (ID_zadanieP) REFERENCES Zadanie_produkcyjne(ID_zadanieP),
...
CREATE TABLE Kontrola_prod (
    ...
    Zatwierdzone BIT NOT NULL,
    Odpady DECIMAL(10,2) NULL,
    ID_zadanieP INT REFERENCES Zadanie_produkcyjne(ID_zadanieP),
    FOREIGN KEY (ID_pracownik) REFERENCES Pracownik(ID_pracownik)
);
GO
...
CREATE TABLE Szczegoly_zamowienia (
    ...
    ID_zamowienie INT NOT NULL FOREIGN KEY REFERENCES Zamowienie(ID_zamowienie),
    ID_produkt INT FOREIGN KEY REFERENCES Produkty(ID_produkt),
...
CREATE TABLE Wlasciwosci (
    ID_wlasciwosci INT IDENTITY(1,1) PRIMARY KEY,
    Nazwa_parametru NVARCHAR(50) NOT NULL,
	ID_jednostki INT NOT NULL FOREIGN KEY REFERENCES Jednostki(ID_jednostki)
);
GO
...
CREATE TABLE Pomiar (
    ...
    ID_Kontrola_prod INT NOT NULL,
    ID_wlasciwosci INT REFERENCES Wlasciwosci(ID_wlasciwosci),
    Wartosc_zmierzona DECIMAL(10,2) NOT NULL,
    FOREIGN KEY (ID_Kontrola_prod) REFERENCES Kontrola_prod(ID_Kontrola_prod)
);
GO

CREATE TABLE Pomiar_mat (
    ID_Pomiar_mat INT IDENTITY(1,1) PRIMARY KEY,
    ID_Kontrola_mat INT NOT NULL,
    ID_wlasciwosci INT NOT NULL,
    Wartosc_zmierzona DECIMAL(10,2) NOT NULL,
    FOREIGN KEY (ID_Kontrola_mat) REFERENCES Kontrola_mat(ID_Kontrola_mat),
    FOREIGN KEY (ID_wlasciwosci) REFERENCES Wlasciwosci(ID_wlasciwosci)
);
GO

CREATE TABLE Produkty_Normy (
    ID_produkty_normy INT IDENTITY(1,1) PRIMARY KEY,
    ID_normy INT NOT NULL FOREIGN KEY REFERENCES Normy(ID_normy),
    ID_produkt INT NOT NULL FOREIGN KEY REFERENCES Produkty(ID_produkt)
);
GO


CREATE TABLE Produkty_wlasciwosci (
    ID_produkty_wlasciwosci INT IDENTITY(1,1) PRIMARY KEY,    
    ID_wlasciwosci INT NOT NULL FOREIGN KEY REFERENCES Wlasciwosci(ID_wlasciwosci),
    ID_produkt INT NOT NULL FOREIGN KEY REFERENCES Produkty(ID_produkt),
...
CREATE TABLE Dostawa (
	...
	Data_dostawy DATETIME2 NOT NULL
);
GO
...
CREATE TABLE Szczegoly_dostawy (
	...
	ID_rodzaj INT NOT NULL FOREIGN KEY REFERENCES Rodzaj_materialu(ID_rodzaj),
	Liczba DECIMAL(6,2) NOT NULL,
	Cena DECIMAL(10,2) NOT NULL
);
GO
...
CREATE TABLE Norma_prod (
	...
	ID_produkt INT NOT NULL FOREIGN KEY REFERENCES Produkty(ID_produkt),
	ID_material INT NOT NULL FOREIGN KEY REFERENCES Material(ID_material),
	Ilosc_mat DECIMAL(6,2) NOT NULL,
	Ilosc DECIMAL(6,2) NOT NULL,
	Czas DECIMAL(6,2) NOT NULL,
	Data_ DATE NOT NULL
);
GO
...
CREATE TABLE Produkcja (
    ...
    ID_pracownik INT NOT NULL FOREIGN KEY REFERENCES Pracownik(ID_pracownik),
	RBH DECIMAL(4,2) NOT NULL,
	Wyprodukowano DECIMAL(6,2) NOT NULL,
	Odpady DECIMAL(6,2) NOT NULL,
...
CREATE TABLE Umowa (
	...
	Data_zak DATE NOT NULL,
	ID_rodzaju INT FOREIGN KEY REFERENCES Rodzaj_umowy(ID_rodzaju)
);
GO

CREATE TABLE Urlop_umowa(
	ID_Urlop_umowa INT IDENTITY(1,1) PRIMARY KEY,
    ID_umowy INT FOREIGN KEY REFERENCES Umowa(ID_umowa),
	ID_urlopu INT FOREIGN KEY REFERENCES Urlop(ID_urlopu),
...
CREATE TABLE Awaria (
    ...
    ID_maszyna INT FOREIGN KEY REFERENCES Maszyna(ID_maszyna),
...
CREATE TABLE Czesci_awaria (
    ...
    ID_czesci INT FOREIGN KEY REFERENCES Czesci_zamienne(ID_czesci),
    ID_awaria INT FOREIGN KEY REFERENCES Awaria(ID_awaria),
    Liczba INT NOT NULL
);
GO
...
CREATE TABLE Obsluga (
    ...
    Data_poczatek DATE NOT NULL,
    ID_pracownik INT FOREIGN KEY REFERENCES Pracownik(ID_pracownik),
	ID_rodzaj_obslugi INT FOREIGN KEY REFERENCES Rodzaj_obslugi(ID_rodzaj_obslugi),
	Uwagi NVARCHAR(50) NOT NULL,
	Data_koniec DATE NOT NULL,
	Przebieg DECIMAL(6,2) NOT NULL
);
GO
...
CREATE TABLE Normy_eksploatacyjne (
	...
	Przebieg_norma DECIMAL(6,2) NOT NULL
);
GO

CREATE TABLE Normy_maszyna (
	ID_Normy_maszyna INT IDENTITY(1,1) PRIMARY KEY,
    ID_normy_ekspl INT FOREIGN KEY REFERENCES Normy_eksploatacyjne(ID_normy_ekspl),
    ID_maszyna INT FOREIGN KEY REFERENCES Maszyna(ID_maszyna),
	Wartosc DECIMAL(6,2) NOT NULL
);
GO
...
CREATE TABLE Czesci_przeglady (
    ...
    ID_czesci INT FOREIGN KEY REFERENCES Czesci_zamienne(ID_czesci),
    ID_obsluga INT FOREIGN KEY REFERENCES Obsluga(ID_obsluga),
    Liczba INT NOT NULL,
	Opis NVARCHAR(50) NOT NULL
);
GO
