...
/* ==========================================
   SCALONY DML Z POPRAWKAMI I BRAKUJACYMI DANYMI
   ========================================== */
...
('Jakub', 'Knocinski', '111222333', 'jakub.knocinski@email.com', 'Warszawa', '00-001', 'Marszalkowska', '10', '39123804281'),
...
('Karolina', 'Zielinska', '777888999', 'karolina.zielinska@email.com', 'Lublin', '20-001', 'Narutowicza', '18', '95042156789'),
...
('Walcownia Silesia S.A.', 'Chorzow', '41-500', 'Stalowa', '8A', '6279876543'),
('Metal-Szpula s.c.', 'Dabrowa Gornicza', '41-300', 'Przemyslowa', '112', '6291112233'),
('Pol-Stal Dystrybucja', 'Krakow', '30-969', 'Nowohucka', '45B', '6780001122'),
('Blach-Hurt', 'Sosnowiec', '41-200', 'Zelazna', '3', '6445556677'),
('NovaStal Centrum Serwisowe', 'Tychy', '43-100', 'Towarowa', '22', '6469998877'),
('Hut-Mat Polfabrykaty', 'Gliwice', '44-100', 'Portowa', '1', '6312223344'),
('Ciecie-Format', 'Czestochowa', '42-200', 'Legionow', '88', '5734445566');
GO

-- ==========================================
-- 4. MATERIAL
-- ==========================================
INSERT INTO Material (Nazwa, Opis) 
VALUES 
('C15x1.6', 'stal'),
('C45x1.6', 'stal'),
('S235JRx1.6', 'stal'),
...
-- 8. JEDNOSTKI
-- ==========================================
INSERT INTO Jednostki (Nazwa_jednostki) VALUES 
('mm'),
('kg');
GO
...
-- 9. NORMY
-- ==========================================
INSERT INTO Normy (Nazwa, Opis) VALUES 
...
-- 10. WLASCIWOSCI
-- ==========================================
INSERT INTO Wlasciwosci (Nazwa_parametru, ID_jednostki) VALUES
('Grubosc', 1),
('Srednica wewnetrzna', 1),
('Srednica zewnetrzna', 1),
('Szerokosc', 1),
('Wysokosc', 1),
('Srednica', 1),
('Dlugosc', 1),
...
-- 12. PRODUKTY_NORMY
-- ==========================================
INSERT INTO Produkty_Normy (ID_normy, ID_produkt) VALUES 
(1, 1), (2, 1), (3, 1),
(1, 2), (2, 2), (3, 2),
(1, 3), (2, 3), (3, 3),
(1, 4), (2, 4), (3, 4);
...
-- ==========================================
-- 13. PRODUKTY_WLASCIWOSCI
-- ==========================================
INSERT INTO Produkty_wlasciwosci (ID_wlasciwosci, ID_produkt, Wartosc_minimalna, Wartosc_maksymalna) VALUES 
(1, 1, 1.55, 1.65), (2, 1, 8.30, 8.50), (3, 1, 15.90, 16.10),
(1, 2, 1.95, 2.05), (2, 2, 10.40, 10.60), (3, 2, 19.80, 20.20),
(1, 3, 2.45, 2.55), (2, 3, 12.80, 13.20), (3, 3, 23.80, 24.20),
(1, 4, 3.92, 4.08), (2, 4, 16.80, 17.20), (3, 4, 29.80, 30.20);
GO

-- ==========================================
-- 14. MATERIAL_WLASCIWOSCI
-- ==========================================
INSERT INTO Material_wlasciwosci (ID_wlasciwosci, ID_material, Wartosc_minimalna, Wartosc_maksymalna) VALUES
(1, 1, 1.55, 1.65), (1, 2, 1.55, 1.65), (1, 3, 1.55, 1.65),
(1, 4, 1.90, 2.10), (1, 5, 1.90, 2.10), (1, 6, 1.90, 2.10),
(1, 7, 3.90, 4.10), (1, 8, 3.90, 4.10), (1, 9, 3.90, 4.10),
(1,10, 3.90, 4.10), (1,11, 3.90, 4.10), (1,12, 3.90, 4.10);
GO

-- ==========================================
-- 15. DOSTAWA
-- ==========================================
INSERT INTO Dostawa (ID_material, ID_firma, ID_pracownik, Data_dostawy) VALUES 
(1, 1, 1, '2026-03-01T14:30:00'),
(2, 1, 2, '2026-03-07T08:32:42'),
(3, 2, 1, '2026-03-09T09:42:21'),
(1, 3, 3, '2026-03-11T10:15:03'),
(2, 2, 1, '2026-03-14T18:15:31'),
(3, 1, 2, '2026-03-18T16:42:13'),
(1, 2, 1, '2026-03-20T12:35:52'),
(1, 1, 1, '2026-03-21T13:28:22'),
(3, 2, 3, '2026-03-27T15:17:42');
GO
...
-- ==========================================
-- 17. SZCZEGOLY_DOSTAWY
-- ==========================================
INSERT INTO Szczegoly_dostawy (ID_dostawa, ID_rodzaj, Liczba, Cena) VALUES 
(1, 1, 200, 5.00),
(2, 3, 300, 4.00),
(3, 1, 500, 3.00),
(4, 1, 300, 5.00),
...
INSERT INTO Szkolenia (Nazwa, Opis, Czy_obowiazkowe, Waznosc_obowiazkowe) VALUES
...
INSERT INTO Typ_zwolnienie (Nazwa, Opis) VALUES
...
INSERT INTO Czesci_zamienne (Nazwa) VALUES
('Lozysko'),
('Pasek klinowy'),
('Filtr oleju');
GO
...
-- ==========================================
-- 20. BADANIA, ZWOLNIENIA, SZKOLENIA
-- ==========================================
...
-- ==========================================
-- 21. MASZYNA / TYP / WYPOSAZENIE
-- ==========================================
INSERT INTO Maszyna (Nazwa, Uwagi, Data_zakupu, Data_uruchomienia, Data_wylaczenia) VALUES
('Prasa_1',NULL,'2026-04-01','2026-04-01',NULL),
('Prasa_2',NULL,'2026-03-23','2026-04-01',NULL),
('Gilotyna_1',NULL,'2026-04-01','2026-04-01',NULL),
('Prasa_3',NULL,'2026-04-05','2026-04-06',NULL),
('Prasa_4',NULL,'2026-04-07','2026-04-08',NULL),
('Gilotyna_2',NULL,'2026-03-01','2026-03-05',NULL),
('Prasa_5',NULL,'2026-04-10','2026-04-11',NULL),
('Gilotyna_3',NULL,'2026-03-10','2026-03-12',NULL),
('Prasa_6',NULL,'2026-04-12','2026-04-13',NULL);
GO
...
-- ==========================================
-- 22. NORMA_PROD / GWARANCJA / MASZYNA_WYP
-- ==========================================
INSERT INTO Norma_prod (ID_produkt, ID_material, Ilosc_mat, Ilosc, Czas, Data_) VALUES
(1,1,260.00,250.00,1.20,'2025-05-04'),
(2,2,325.00,312.00,1.00,'2025-06-07'),
(1,2,210.00,199.00,0.99,'2025-03-13'),
(2,1,415.00,400.00,1.50,'2025-07-01'),
(3,2,160.00,150.00,0.80,'2025-02-11'),
(1,3,620.00,600.00,2.10,'2025-08-20'),
(2,3,290.00,275.00,1.30,'2025-04-17'),
(3,1,345.00,330.00,1.10,'2025-06-30'),
(1,2,520.00,500.00,1.80,'2025-09-10');
GO
...
(1,'2024-06-01',1,'Uszkodzone lozysko','2024-06-02'),
(2,'2024-06-02',2,'Zerwany pasek','2024-06-03'),
(3,'2024-06-03',3,'Wycieki oleju','2024-06-04'),
(1,'2024-06-04',4,'Halas','2024-06-05'),
(2,'2024-06-05',5,'Przegrzewanie','2024-06-06'),
(3,'2024-06-06',6,'Drgania','2024-06-07'),
(1,'2024-06-07',7,'Awaria silnika','2024-06-08'),
(2,'2024-06-08',8,'Zuzycie czesci','2024-06-09'),
(3,'2024-06-09',9,'Uszkodzenie filtra','2024-06-10');
GO
...
(1,'2024-06-01',1,1,'OK','2024-06-01',50.00),
(2,'2024-06-02',2,2,'Naprawa','2024-06-02',60.00),
(3,'2024-06-03',3,3,'Konserwacja','2024-06-03',40.00),
(1,'2024-06-04',4,1,'OK','2024-06-04',55.00),
(2,'2024-06-05',5,2,'Naprawa','2024-06-05',70.00),
(3,'2024-06-06',6,3,'Konserwacja','2024-06-06',30.00),
(1,'2024-06-07',7,1,'OK','2024-06-07',50.00),
(2,'2024-06-08',8,2,'Naprawa','2024-06-08',65.00),
(3,'2024-06-09',9,3,'Konserwacja','2024-06-09',45.00);
GO
...
(4, 2, 8000.00, 5, 'Pilne', 1.25),
(5, 1, 9999.00, 4, 'Stala wspolpraca', 0.85),
(6, 4, 4000.00, 3, 'Priorytet', 0.15),
(7, 4, 9999.00, 2, 'Powtorzenie zlecenia', 0.60),
(8, 3, 9000.00, 3, 'Partia testowa', 0.25),
(9, 2, 5000.00, 5, 'Standard', 1.30),
(10, 1, 9999.00, 4, 'Odbior etapowy', 0.90);
GO

-- ==========================================
-- 25. KONTROLA MATERIALU I PRODUKTU
-- ==========================================
